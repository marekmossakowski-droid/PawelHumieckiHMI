...
`WAVE R2 REMEDIATION = R2-D/E FRESHLY REVERIFIED / PR #111 OWNER MERGE APPROVAL REQUIRED`
...
- `AUD-HC-024`–`AUD-HC-025`: `FRESH R2-D/E REVERIFICATION VERIFIED / PR #111 OWNER MERGE APPROVAL REQUIRED`.
...
- `Generation 1 GUI runtime`: `G1-1..G1-6 IMPLEMENTED / VERIFIED / RECONCILED FOR BOUNDED SYNTHETIC SCOPE VIA PR #110`.
...
- G1-6 approved head `0ba49f341dff4a1ebc390ed92173d279e73a84f6` merged as `cd1e19e552b2f7a74c696dd466ed3b80f05b7ee8`; Repository Verification PASS.
...
## Wave R2 current evidence
- R2-A/B/C remain previously reverified under governance recovery.
- Historical PR #77 is superseded for final authority lineage because its base predates the current verified `main` by many subsequent workstreams.
- Fresh candidate PR #111 starts from `main@cd1e19e552b2f7a74c696dd466ed3b80f05b7ee8`.
- Fresh RED `13100320ffd5f48c38f96a0d7eea8602a1715f2d` → production GREEN `fc4024d05d147b037ae064baeae1cd7cb4772c5f` → final test-corrected GREEN `b87c14d47a8822b166e43b90182fa3b3797b2c9b`.
- `runtime-ci #528 = SUCCESS`, `docs-ci #407 = SUCCESS`.
- R2-D/E behavior is local synthetic/test-only: reproducible runtime config/entrypoint/restart, network/KVK fail-closed flags, RFID identity derived from observation payload, and mismatch rejection before identity commit.
- R2 closure is not established by PR #111 and remains a separate future gate.

## Explicit unresolved dependencies
- `edge_host = EDGE_HOST_REQUIRED / NOT YET SELECTED` for physical deployment.
...
- formal R2 closure remains open.
