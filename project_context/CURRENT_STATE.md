...
- `REQ-HC-002-S1`: `PROPOSED / NOT BASELINED — PROJECT OWNER APPROVAL REQUIRED`.
- `IA-HC-007-S1`: `PROPOSED / NOT ACTIVE — PROJECT OWNER APPROVAL REQUIRED`.
- `IA-HC-007-S1 runtime`: `NOT AUTHORIZED / NOT STARTED`.
