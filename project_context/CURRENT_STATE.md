...
- `REQ-HC-003-G1`: `PROPOSED / NOT BASELINED`.
- `UX-HC-002`: `DRAFT / CONTENT APPROVAL REQUIRED / IMPLEMENTATION NOT AUTHORIZED`.
- `IA-HC-008`: `PROPOSED / NOT ACTIVE`.
- `Generation 1 GUI/DTools runtime`: `NOT AUTHORIZED / NOT STARTED`.
