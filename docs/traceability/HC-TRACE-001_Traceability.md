...
| P5 Physical navigation/state binding | `5995068062bd21b15702f8bc5a192fb74ca3438b` | GREEN `a00ca743a58ae15b1f95eded4cb94ca50a387c2f` | IMPLEMENTED / GREEN |

## P5 verified invariants
- navigation follows the approved dashboard → animal → limb/claw → zone/lesion → treatment → report sequence;
